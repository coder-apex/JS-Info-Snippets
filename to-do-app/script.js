...
// Using Better Comments Extension on vsCode
//* Highlighted comment
//! Warning
//? Question?
//TODO 
...
// // create currentTaskListArray object to store tasks for session
// // As the value of currentTaskListArray is changed, it is reflected in localStorage by updating its value
// let currentTaskListArray = [];

// // create localStorage item if it does not exist
// if (localStorage.getItem('localTasks') === null) {
//   currentTaskListArray = [];
// } else {
//   currentTaskListArray = JSON.parse(localStorage.getItem('localTasks'));
// }
...
//   currentTaskListArray.push(task);
//   // displaycurrentTaskListArray();
...
// // FUNCTION - populateTasks() is executed at the initial setup phase of the script and populates the tasks that are stored in local storage on the HTML Page
// function populateTasks(){
//   currentTaskListArray.forEach(taskInTaskList => {
//     createTask(taskInTaskList);
//   });
// }
...
//     taskList.innerHTML = '';
//     currentTaskListArray = [];
//     localStorage.setItem('localTasks', JSON.stringify(currentTaskListArray));

//     lkj("After Delete ALL:");
//     displaycurrentTaskListArray();
// }

// // FUNCTION - updateLocalStorage() is called when a value in currentTaskListArray changes and localStorage needs to be updated
// function updateLocalStorage() {
//   localStorage.setItem('localTasks', JSON.stringify(currentTaskListArray));
// }

// // FUNCTION - removeTaskFromTaskList() is called to remove a task form currentTaskListArray 
// function removeTaskFromTaskList(task) {
//   var index = currentTaskListArray.indexOf(task);
//   if (index > -1) {
//     currentTaskListArray.splice(index, 1);
//   }
// }
...
// // FUNCTION - 
// function displaycurrentTaskListArray(){
//   lkj("Current task list Array:");
//   lkj(currentTaskListArray);
// }